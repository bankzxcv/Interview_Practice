# Tutorial 03: Data Modeling Principles

## Objectives

Learn Data Modeling Principles for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/03_data_modeling
docker-compose up -d
```
