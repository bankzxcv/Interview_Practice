# Tutorial 10: Kubernetes with K8ssandra

## Objectives

Learn Kubernetes with K8ssandra for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/10_kubernetes_deployment
docker-compose up -d
```
