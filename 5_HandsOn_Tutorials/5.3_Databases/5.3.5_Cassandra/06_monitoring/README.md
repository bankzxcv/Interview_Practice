# Tutorial 06: Monitoring & Ops

## Objectives

Learn Monitoring & Ops for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/06_monitoring
docker-compose up -d
```
