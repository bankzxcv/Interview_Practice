# Tutorial 02: Docker Compose Multi-Node

## Objectives

Learn Docker Compose Multi-Node for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/02_docker_compose
docker-compose up -d
```
