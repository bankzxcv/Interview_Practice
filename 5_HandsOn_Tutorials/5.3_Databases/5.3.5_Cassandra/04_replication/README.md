# Tutorial 04: Replication Strategies

## Objectives

Learn Replication Strategies for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/04_replication
docker-compose up -d
```
