# Tutorial 05: Backup & Restore

## Objectives

Learn Backup & Restore for Cassandra with hands-on practical examples.

## Topics Covered

- Snapshots with nodetool\n- Incremental backups\n- Point-in-time recovery\n- Automated backup scripts

## Quick Start

```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/05_backup_restore
docker-compose up -d
```
