# Tutorial 09: Multi-Datacenter Setup

## Objectives

Learn Multi-Datacenter Setup for Cassandra with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.5_Cassandra/09_multi_datacenter
docker-compose up -d
```
