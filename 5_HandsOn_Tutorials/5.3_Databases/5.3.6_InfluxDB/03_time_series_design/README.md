# Tutorial 03: Time Series Schema Design

## Objectives

Learn Time Series Schema Design for InfluxDB with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.6_InfluxDB/03_time_series_design
docker-compose up -d
```
