# Tutorial 04: Retention & Downsampling

## Objectives

Learn Retention & Downsampling for InfluxDB with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.6_InfluxDB/04_retention_policies
docker-compose up -d
```
