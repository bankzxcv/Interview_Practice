# Tutorial 08: InfluxDB Enterprise Clustering

## Objectives

Learn InfluxDB Enterprise Clustering for InfluxDB with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.6_InfluxDB/08_clustering
docker-compose up -d
```
