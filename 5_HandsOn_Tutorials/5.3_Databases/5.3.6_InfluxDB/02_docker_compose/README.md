# Tutorial 02: TICK Stack Setup

## Objectives

Learn TICK Stack Setup for InfluxDB with hands-on practical examples.

## Topics Covered

- Telegraf for data collection\n- InfluxDB for storage\n- Chronograf for visualization\n- Kapacitor for alerts

## Quick Start

```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.6_InfluxDB/02_docker_compose
docker-compose up -d
```
