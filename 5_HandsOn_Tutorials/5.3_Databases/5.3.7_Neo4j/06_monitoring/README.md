# Tutorial 06: Monitoring & Performance

## Objectives

Learn Monitoring & Performance for Neo4j with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.7_Neo4j/06_monitoring
docker-compose up -d
```
