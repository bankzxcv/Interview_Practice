# Tutorial 08: Causal Clustering

## Objectives

Learn Causal Clustering for Neo4j with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.7_Neo4j/08_clustering
docker-compose up -d
```
