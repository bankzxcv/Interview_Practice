# Tutorial 10: Kubernetes Deployment

## Objectives

Learn Kubernetes Deployment for Neo4j with hands-on practical examples.

## Topics Covered

- Neo4j Helm charts\n- StatefulSets\n- Causal cluster on K8s\n- Cloud deployment

## Quick Start

```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.7_Neo4j/10_kubernetes_deployment
docker-compose up -d
```
