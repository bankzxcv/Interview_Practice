# Tutorial 05: Persistence Strategies

## Objectives

Learn Persistence Strategies for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/05_persistence
docker-compose up -d
```
