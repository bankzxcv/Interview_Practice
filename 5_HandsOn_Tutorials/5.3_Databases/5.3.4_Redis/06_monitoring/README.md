# Tutorial 06: Monitoring & Metrics

## Objectives

Learn Monitoring & Metrics for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/06_monitoring
docker-compose up -d
```
