# Tutorial 08: Redis Cluster

## Objectives

Learn Redis Cluster for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/08_clustering
docker-compose up -d
```
