# Tutorial 04: Replication & Sentinel

## Objectives

Learn Replication & Sentinel for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/04_replication
docker-compose up -d
```
