# Tutorial 03: Advanced Data Structures

## Objectives

Learn Advanced Data Structures for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/03_data_structures
docker-compose up -d
```
