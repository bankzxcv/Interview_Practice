# Tutorial 02: Docker Compose with Redis Commander

## Objectives

Learn Docker Compose with Redis Commander for Redis with hands-on practical examples.
...
```bash
cd /home/user/Interview_Practice/5_HandsOn_Tutorials/5.3_Databases/5.3.4_Redis/02_docker_compose
docker-compose up -d
```
